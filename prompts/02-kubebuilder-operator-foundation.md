# Prompt 02 — Kubebuilder / Operator Foundation
...
Context:
The project needs Kubernetes CRDs and controllers. If the kubebuilder CLI is available, use it. If not, manually create a compatible layout and document the kubebuilder commands that would have been used.
...
3. Add minimal controllers in /internal/controller for BuildRun, Release and Project.
